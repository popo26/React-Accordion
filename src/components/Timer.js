...
function Timer({ countdown, previousCount, isTimerStarted, doneFirstQuiz }) {

    // const [countdown, setCountdown] = useState(10);
    // const previousCount = useRef(countdown);

    // const startCount = () => {
    //     const timesUp = setInterval(function () {
    ...
    return (
        <div className="timer-div">
            {isTimerStarted ? <h2 className="timer">{countdown} 
            <div className="bomb-icon" ><iconify-icon icon="streamline-emojis:bomb" width="80px"></iconify-icon></div></h2> 
